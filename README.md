...
| Resource | Link |
|---|---|
| Paper LaTeX source | https://github.com/hq0709/MedVIGIL-paper |
| Benchmark dataset | https://huggingface.co/datasets/jhq0709/MedVIGIL |
| Original code repo | https://github.com/hq0709/MedVIGIL |
...
Page source under MIT. Embedded figures inherit the licence of the parent paper (see `MedVIGIL-paper`).
